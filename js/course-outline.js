...
const COURSE_OUTLINE = {
  ...
  module4: [
    ...
    { title: "Activity: Find the TATA Box", readId: "4.5s" },
    { title: "Terminator Motifs", readId: "4.6r" },
    { title: "Promoters and Terminators by Cell Type", readId: "4.7r" },
    { title: "Practice: Eukaryotic Promoter Motifs", readId: "4.8p" },
    { title: "Practice: Identifying Bacterial Promoters", readId: "4.9p" },
    { title: "Practice: Plant Terminators", readId: "4.10p" },
    { title: "Practice: True Statements About Promoters", readId: "4.11p" },
    { part: "Part 2: Components that Determine Translation", title: "Start/Stop Codons and the Coding Sequence", readId: "4.13r" },
    { title: "Translation Initiation: Kozak vs. Shine-Dalgarno", readId: "4.14r", checkId: "4.15p", checkTitle: "Practice: Finding the Stop Codon" },
    { part: "Part 3: Logic Gates", title: "What Is a Logic Gate?", readId: "4.18r" },
    { title: "AND-Gates", readId: "4.19r" },
    { title: "OR-Gates", readId: "4.20r", checkId: "4.21p", checkTitle: "Practice: The Arabinose/Rhamnose AND & OR Gate" },
    { part: "Part 4: More Advanced Systems", title: "Activators and Repressors", readId: "4.22r", checkId: "4.23p", checkTitle: "Practice: How Repressors Respond to Their Target Molecule" },
    { title: "Feedback Loops", readId: "4.24r", checkId: "4.25p", checkTitle: "Practice: Positive or Negative Feedback?" }
  ],
  module5: [
  ...
  module8: [
    ...
    { title: "Beyond Individual Consent", readId: "8.16r" },
    { title: "Gain-of-Function Research and H5N1", readId: "8.17r", checkId: "8.18p", checkTitle: "Areas of Concern in Gain-of-Function Research" },
    { title: "Safeguards for High-Risk Research", readId: "8.19f" },
    { title: "Layers of Protection", readId: "8.20r" },
    { title: "Gray Areas: CAR-T Cell Therapy", readId: "8.21r", checkId: "8.22f", checkTitle: "CAR-T: Ethical Gray Areas" },
    { title: "CAR-T: Access and Risk", readId: "8.23r" },
    { part: "Part 4: Oversight and Governance", title: "Who Actually Decides Whether Research Can Happen?", readId: "8.24r", checkId: "8.25m", checkTitle: "Which Committee Reviews Which Research" },
    { title: "Institutional Review Boards", readId: "8.26r" },
    { title: "Institutional Animal Care and Use Committees", readId: "8.27r" },
    { title: "Institutional Biosafety Committees", readId: "8.28r", checkId: "8.29m", checkTitle: "Committees Across a Project's Lifecycle" },
    { title: "FDA Oversight of Clinical Trials", readId: "8.30r" },
    { title: "Who Decides What Research Gets Funded?", readId: "8.31r", checkId: "8.32m", checkTitle: "Other Rules That Shape Research" },
    { part: "Part 5: Conclusion", title: "Putting It All Together", readId: "8.33r", checkId: "8.34f", checkTitle: "Closing Reflection" }
  ]
};
